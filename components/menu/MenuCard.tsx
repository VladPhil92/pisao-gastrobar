      ...
      <div className="flex flex-1 flex-col p-5 sm:p-6">
        ...
        <div className="border-pisao-gold/10 mt-5 flex items-center justify-between gap-3 border-t pt-4">
          ...
          <button
            ...
            className="bg-pisao-gold text-pisao-carbon hover:bg-pisao-gold-light inline-flex min-h-10 items-center gap-2 rounded-full px-4 py-2 text-xs font-bold transition disabled:cursor-not-allowed disabled:opacity-40"

...
export function MenuBrowser({
  ...
  return (
    <div className="pb-24 sm:pb-28">
            ...
            <div className="border-pisao-gold/20 bg-pisao-noche/70 text-pisao-cream flex shrink-0 items-center gap-3 rounded-2xl border px-4 py-3 text-sm backdrop-blur-xl">
              ...
              <div>
                ...
                <p className="text-pisao-cream-muted text-[11px]">
                  Se activa con tu primer producto.
                </p>
              </div>
            </div>
          </div>
      ...
      <section
        key={active ?? "all"}
        className="pisao-stage-shift relative mt-9 scroll-mt-36 overflow-hidden rounded-[2rem] border border-pisao-gold/10 bg-pisao-noche"
      >
        {heroProduct?.imagenUrl && (
          <div className="absolute inset-0 lg:left-[54%]">
            <Image
              ...
              className="object-cover opacity-55 transition duration-700 lg:opacity-100"
            />
